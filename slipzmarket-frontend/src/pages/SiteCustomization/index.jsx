...
const SiteCustomization = () => {
  ...
  const renderLocalization = () => (
    <div className="animate-fade-in flex flex-col gap-3 md:gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-2 gap-2">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">System Timezone</label>
          <select 
        ...
        <div className="flex flex-col gap-1.5 md:col-span-2">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Date Format</label>
          <select 
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 mt-3">
          <button onClick={handleSave} className="sm:text-xs md:text-xs lg:text-xs px-3 py-1 rounded bg-[#8b6f5a] text-white">Publish Changes</button>
          ...
          }} className="sm:text-xs md:text-xs lg:text-xs px-3 py-1 rounded bg-white border">Save Template</button>
          ...
          {editingTemplateId && (
            ...
            }} className="sm:text-xs md:text-xs lg:text-xs px-3 py-1 rounded border bg-red-50 text-red-600">Delete Template</button>
          )}
        </div>
      </div>

      <div className="mt-2 flex flex-col gap-2">
        <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Enabled Languages</label>
        <div className="grid md:grid-cols-2 grid-cols-1 sm:grid-cols-3 gap-2">
            ...
            return (
              ...
              >
                <div className="flex flex-col">
                  <span className={`text-xs font-bold ${isEnabled ? 'break-words text-[#3b2a23]' : 'text-[#8b6f5a]'}`}>{lang.name}</span>
                  <span className="sm:text-xs md:text-xs lg:text-xs font-sans mt-0.5">{lang.code}</span>
                </div>
                {isDefault && <span className="text-xs font-bold bg-[#8b6f5a] text-white px-2 py-0.5 rounded uppercase">Default</span>}
    ...
    <div className="animate-fade-in flex flex-col gap-3 md:gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 md:gap-6 items-center p-4 bg-[#faf6f0] border border-[#d6c9b8] rounded-lg">
        ...
        <div className="flex-1 min-w-0 text-center sm:text-left">
          <h4 className="sm:text-xs md:text-xs md:text-sm lg:text-sm font-bold break-words text-[#3b2a23]">Platform Logo</h4>
          <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a] mt-0.5 mb-2">Recommended size: 256x256px (PNG or SVG)</p>
          <button type="button" className="sm:text-xs md:text-xs lg:text-xs font-bold break-words text-[#3b2a23] bg-white border border-[#d6c9b8] px-3 py-1.5 rounded-md hover:bg-[#f5efe6] transition-colors">
            Upload New Image
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-3 gap-2">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Accent Color</label>
          <div className="flex flex-col sm:flex-row items-center gap-2">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Background</label>
          <div className="flex flex-col sm:flex-row items-center gap-2">
      ...
      <div className="flex flex-col gap-1.5 mt-2">
        <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest flex flex-col sm:flex-row items-center gap-1.5"><Type size={16}/> Base Font Family</label>
        <select 
  ...
  const renderScripts = () => (
    <div className="animate-fade-in flex flex-col gap-3 md:gap-6">
      <div className="flex flex-col gap-1 border-b border-[#d6c9b8] pb-3">
        ...
        <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a] font-medium">Inject tracking codes or custom CSS globally into the application.</p>
      </div>

      <div className="flex flex-col gap-2">
        <div className="flex flex-col gap-1.5">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest flex flex-col sm:flex-row items-center gap-1.5"><Globe size={16}/> Google Analytics ID</label>
          <input 
            type="text" 
        ...
        <div className="flex flex-col gap-1.5">
          <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest flex flex-col sm:flex-row items-center gap-1.5"><Code size={16}/> Global &lt;head&gt; Code</label>
          <textarea 
            rows="6"
            value={config.customHeadCode}
            onChange={(e) => handleChange('customHeadCode', e.target.value)}
            placeholder=""
            className="w-full bg-[#3b2a23] text-[#d6c9b8] border border-[#d6c9b8] rounded-lg p-4 sm:text-xs md:text-xs lg:text-xs font-sans outline-none focus:ring-2 focus:ring-[#8b6f5a] resize-none"
          />
          <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a]">This code will be injected before the closing `&lt;/head&gt;` tag on all pages.</p>
        </div>
      </div>
    </div>
  );
  ...
  const renderEmails = () => (
    <div className="animate-fade-in flex flex-col gap-3 md:gap-6">
      <div className="flex flex-col gap-1 border-b border-[#d6c9b8] pb-3">
        ...
        <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a] font-medium">Customize the automated emails sent to users.</p>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="bg-[#faf6f0] border border-[#d6c9b8] rounded-lg p-4 flex flex-col gap-2">
          <div className="flex flex-col gap-1.5">
            <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Subject Line</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-1.5">
            <label className="sm:text-xs md:text-sm lg:text-sm font-bold text-[#8b6f5a] uppercase tracking-widest">Email Body</label>
            <textarea 
              rows="8"
      ...
      <div className="animate-fade-in flex flex-col gap-3 md:gap-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a] font-medium">Add, view, or update environment / secret variables stored in site settings.</p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-2">
            <button onClick={loadDefaults} className="sm:text-xs md:text-xs lg:text-xs px-3 py-1 rounded bg-white border border-[#d6c9b8] hover:bg-[#faf6f0] transition-colors">Load Defaults</button>
            <button onClick={addVar} className="sm:text-xs md:text-xs lg:text-xs px-3 py-1 rounded bg-[#8b6f5a] hover:bg-[#6c5544] text-white transition-colors">Add Variable</button>
          </div>
        </div>

        <div className="grid gap-2 mt-4">
          {entries.length === 0 && <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a]">No system variables configured.</p>}
          {entries.map(([k, v], i) => (
            <div key={`${k}-${i}`} className="flex flex-col md:flex-row gap-2 items-center group">
              <input 
                value={k} 
                onChange={(e) => handleVarChange(i, 'key', e.target.value)} 
                className="w-1/3 bg-white border border-[#d6c9b8] rounded-lg px-3 py-2 sm:text-xs md:text-xs lg:text-xs font-sans text-[#8b6f5a] outline-none focus:border-[#8b6f5a]" 
  ...
  return (
    <div className="flex flex-col h-full bg-[#f5efe6] font-sans pb-8 selection:bg-[#8b6f5a] selection:text-white" style={{ zoom: '1.22' }}>
      
      {/* --- HEADER --- */}
      <div className="overflow-x-auto bg-white border-b border-[#d6c9b8] px-0 lg:px-0 py-2 sticky top-0 z-30 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 w-full">
          <div>
            <h1 className="text-xs md:text-xs font-bold break-words text-[#3b2a23] tracking-tight" style={{ fontSize: '78%' }}>{t('siteCustomizationTitle', 'Site Customization')}</h1>
            <p className="sm:text-xs md:text-xs lg:text-xs text-[#8b6f5a] font-medium mt-0.5">{t('siteCustomizationSubtitle', 'Manage globals and settings')}</p>
          </div>
          <button 
            onClick={handleSave}
            disabled={isSaving}
            className="flex items-center justify-center gap-2 bg-[#8b6f5a] hover:bg-[#6c5544] text-white px-3 md:px-6 py-1.5.5 rounded-lg shadow-sm sm:text-xs md:text-xs lg:text-xs font-bold transition-all disabled:opacity-70 w-full md:w-auto"
          >
      ...
      <div className="px-0 mt-5 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-3 md:gap-6 items-start">
        ...
        <div className="lg:col-span-3 flex flex-col gap-1.5 sticky top-24">
          <button 
            ...
            className={`flex flex-col sm:flex-row items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors w-full text-left ${activeTab === 'localization' ? 'bg-white border border-[#d6c9b8] break-words text-[#3b2a23] shadow-sm' : 'text-[#8b6f5a] hover:bg-white/50 hover:break-words text-[#3b2a23] border border-transparent'}`}
          >
            <Languages size={16} className={activeTab === 'localization' ? 'text-[#8b6f5a]' : 'opacity-70'} /> {t('localization', 'Localization')}
          </button>
          <button 
            onClick={() => setActiveTab('theme')}
            className={`flex flex-col sm:flex-row items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors w-full text-left ${activeTab === 'theme' ? 'bg-white border border-[#d6c9b8] break-words text-[#3b2a23] shadow-sm' : 'text-[#8b6f5a] hover:bg-white/50 hover:break-words text-[#3b2a23] border border-transparent'}`}
          >
            <Palette size={16} className={activeTab === 'theme' ? 'text-[#8b6f5a]' : 'opacity-70'} /> {t('themeBrand', 'Theme & Brand')}
          </button>
          <button 
            onClick={() => setActiveTab('scripts')}
            className={`flex flex-col sm:flex-row items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors w-full text-left ${activeTab === 'scripts' ? 'bg-white border border-[#d6c9b8] break-words text-[#3b2a23] shadow-sm' : 'text-[#8b6f5a] hover:bg-white/50 hover:break-words text-[#3b2a23] border border-transparent'}`}
          >
            <Code size={16} className={activeTab === 'scripts' ? 'text-[#8b6f5a]' : 'opacity-70'} /> {t('customScripts', 'Custom Scripts')}
          </button>
          <button 
            onClick={() => setActiveTab('emails')}
            className={`flex flex-col sm:flex-row items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors w-full text-left ${activeTab === 'emails' ? 'bg-white border border-[#d6c9b8] break-words text-[#3b2a23] shadow-sm' : 'text-[#8b6f5a] hover:bg-white/50 hover:break-words text-[#3b2a23] border border-transparent'}`}
          >
            <Mail size={16} className={activeTab === 'emails' ? 'text-[#8b6f5a]' : 'opacity-70'} /> {t('emailTemplates', 'Email Templates')}
          </button>
          <button 
            onClick={() => setActiveTab('system')}
            className={`flex flex-col sm:flex-row items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-bold transition-colors w-full text-left ${activeTab === 'system' ? 'bg-white border border-[#d6c9b8] break-words text-[#3b2a23] shadow-sm' : 'text-[#8b6f5a] hover:bg-white/50 hover:break-words text-[#3b2a23] border border-transparent'}`}
          >
        ...
        {/* Content Area */}
        <div className="lg:col-span-9 overflow-x-auto bg-white border border-[#d6c9b8] rounded-lg shadow-sm p-6 min-h-100">
      ...
      {/* --- TOAST NOTIFICATION --- */}
      {toast && (
        <div className="fixed bottom-8 right-8 z-80 bg-[#3b2a23] text-white px-3 md:px-6 py-1.5 rounded-lg shadow-2xl flex flex-col sm:flex-row items-center gap-2.5 animate-fade-in-up border border-[#8b6f5a]" style={{ transform: 'scale(0.9)' }}>
          {toast.type === 'error' ? <X size={16} className="text-red-400" /> : <CheckCircle2 size={16} className="text-emerald-400" />}
